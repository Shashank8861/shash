...
class CreaterecordWidget extends StatefulWidget {
  const CreaterecordWidget({Key key}) : super(key: key);
                ...
                onPressed: () async {
                  final placesCreateData = {
                    ...createPlacesRecordData(
                      ...
                      famousThingToTakehome: valueOrDefault<String>(
                  ...
                  final placesRecordReference = PlacesRecord.collection.doc();
                  await placesRecordReference.set(placesCreateData);
                  abcd = PlacesRecord.getDocumentFromData(
                      placesCreateData, placesRecordReference);
